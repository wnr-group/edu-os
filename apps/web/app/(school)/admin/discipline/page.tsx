...
export default async function AdminDisciplinePage() {
  ...
  const { data: records } = await supabase
    ...
    .select("id, student_id, category, severity, status, description, created_at, student:student_profiles(full_name, enrollments:student_enrollments(roll_number, section:sections(name, class:classes(name))))")
